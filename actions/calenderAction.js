import {
  ALL_CALENDER_FAIL,
  ALL_CALENDER_REQUEST,
  ALL_CALENDER_SUCCESS,
  CALENDER_DETAILS_FAIL,
  CALENDER_DETAILS_REQUEST,
  CALENDER_DETAILS_SUCCESS,
  CLEAR_ERRORS,
  CREATE_CALENDER_FAIL,
  CREATE_CALENDER_REQUEST,
  CREATE_CALENDER_SUCCESS,
  DELETE_CALENDER_FAIL,
  DELETE_CALENDER_REQUEST,
  DELETE_CALENDER_SUCCESS,
  UPDATE_CALENDER_FAIL,
  UPDATE_CALENDER_REQUEST,
  UPDATE_CALENDER_SUCCESS,
