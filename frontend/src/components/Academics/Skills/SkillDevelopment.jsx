...
myForm.set("country", country?.label ?? "");
  ...
  const featured = [
    ...
    },[error,dispatch,FeedError,cardError,partnerError,featureError , FormError , success])
      ...
      <Fragment>
        {
          loading ? (<Loader/>):(
              <Fragment>
                <Metadata title={`Skill Development - The Learning Hub`} />

          <div className="servicesDetailsContainer">
            <div className='topDevelopmentContainer'>
