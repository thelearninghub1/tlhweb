...
import { createExtraAction , clearErrors } from '../../../actions/affilationAction';
...
const CreateExtra = () => {
  ...
  const createHightlightSubmitHandler  = (e) => {
    ...
    dispatch(createExtraAction(myForm));
  }
  ...
  useEffect(() => {
    ...
    if (success) {
      toast.success('Extra Activity Created Successfully');
      history(`/dashboard`)
            ...
            loading ? (<Loader/>) : (
              ...
              <div className='dashboardMainWrapper'>
                ...
                <div className=" createdashboard">
                    ...
                    <h1>Create Extra Curricular Activity Card</h1>
