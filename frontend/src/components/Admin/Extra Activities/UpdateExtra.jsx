...
import { updateExtraAction , clearErrors, extraDetailsAction } from '../../../actions/affilationAction';
...
const UpdateExtra = () => {
  ...
  const createHightlightSubmitHandler  = (e) => {
    ...
    dispatch(updateExtraAction(id,myForm));
  }
  ...
  useEffect(() => {
    ...
    if (afiliation && afiliation._id !== id) {
        dispatch(extraDetailsAction(id));
            ...
            loading ? (<Loader/>) : (
              ...
              <div className='dashboardMainWrapper'>
                ...
                <div className=" createdashboard">
                    ...
                    <h1>Update Extra Curricular Activity Card</h1>
