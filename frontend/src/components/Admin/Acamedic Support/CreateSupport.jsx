...
import { createSupportAction , clearErrors } from '../../../actions/affilationAction';
...
const CreateSupport = () => {
  ...
  const createHightlightSubmitHandler  = (e) => {
    ...
    dispatch(createSupportAction(myForm));
  }
  ...
  useEffect(() => {
    ...
    if (success) {
      toast.success('Academic Support Created Successfully');
      history(`/dashboard`)
            ...
            loading ? (<Loader/>) : (
              ...
              <div className='dashboardMainWrapper'>
                ...
                <div className=" createdashboard">
                    ...
                    <h1>Create Academic Support Methods</h1>
