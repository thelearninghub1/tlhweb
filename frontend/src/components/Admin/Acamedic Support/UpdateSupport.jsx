...
import { updateSupportAction , clearErrors, supportDetailsAction } from '../../../actions/affilationAction';
...
const UpdateSupport = () => {
  ...
  const createHightlightSubmitHandler  = (e) => {
    ...
    dispatch(updateSupportAction(id,myForm));
  }
  ...
  useEffect(() => {
    ...
    if (success) {
      toast.success('Academic Support Updated Successfully');
      history(`/dashboard`)
      dispatch({type: UPDATE_AFFILIATION_RESET});
    }

    if (afiliation && afiliation._id !== id) {
        dispatch(supportDetailsAction(id));
            ...
            loading ? (<Loader/>) : (
              ...
              <div className='dashboardMainWrapper'>
                ...
                <div className=" createdashboard">
                    ...
                    <h1>Update Academic Support Methods</h1>
