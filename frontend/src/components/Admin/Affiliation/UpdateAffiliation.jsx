...
import { updateAffiliationAction , clearErrors, affiliationDetailsAction } from '../../../actions/affilationAction';
...
const UpdateAffiliation = () => {
  ...
  const createHightlightSubmitHandler  = (e) => {
    ...
    dispatch(updateAffiliationAction(id,myForm));
  }
  ...
  useEffect(() => {
    ...
    if (afiliation && afiliation._id !== id) {
        dispatch(affiliationDetailsAction(id));
