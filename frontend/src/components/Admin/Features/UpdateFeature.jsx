...
import { updateFeatureAction , clearErrors, featureDetailsAction } from '../../../actions/affilationAction';
...
const UpdateFeature = () => {
  ...
  const createHightlightSubmitHandler  = (e) => {
    ...
    dispatch(updateFeatureAction(id,myForm));
  }
  ...
  useEffect(() => {
    ...
    if (afiliation && afiliation._id !== id) {
        dispatch(featureDetailsAction(id));
