...
import { deleteInstrutionalAction , clearErrors , allInstructionalAction } from '../../../actions/affilationAction.jsx';
...
const AllInstructional = () => {
  ...
  const deleteSubmitHandler = (id) => {
    dispatch(deleteInstrutionalAction(id))
  ...
  {
    field:"title",
    headerName:"Instructional Title",
    minWidth:200,
    flex:1
  },
    {
    field:"description",
    headerName:"Instructional Description",
    minWidth:300,
    flex:1
  },
                ...
                <div className='dashboardMainWrapper'>
                  ...
                  <div className="dashboardLayout">
                      ...
                      <div className="productListContainer" style={{ width: '100%', overflowX: 'auto' }}>
                        <h1 id='productListHeading'>All Instructional Data Management</h1>
                        <DataGrid
                          rows={rows}
                          columns={columns}
                          pageSize={10}
...
export default AllInstructional